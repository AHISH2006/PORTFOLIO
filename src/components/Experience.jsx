...
const EXPERIENCES = [
  {
    ...
    year: "2024",
    desc: "Developed responsive web interfaces and cross-platform mobile apps using React and React Native. Integrated REST APIs, improved UI/UX, and collaborated using Git/GitHub.",
    tags: ["React", "React Native", "Expo CLI", "REST APIs", "JavaScript"],
    color: "#f59e0b",
    icon: "⚡",
    side: "left",
  },
  {
    ...
    year: "2025",
    desc: "Designed and developed modern MERN stack applications. Built responsive UIs, integrated RESTful APIs, and managed data with MongoDB for seamless full-stack solutions.",
